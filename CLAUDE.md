...
```
build/          icon.png, generated by scripts/make-icon.py
...
scripts/        smoke tests, the macOS installer, the icon generator
```

## Packaging

`scripts/install-mac.sh` is the one-command macOS install. It prefers a
